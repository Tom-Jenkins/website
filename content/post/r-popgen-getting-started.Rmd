...
ggplot(data = Het_lobster_df, aes(x = Site, y = value, fill = variable))+
  ...
  scale_fill_manual(values = c("royalblue", "#bdbdbd"))+
  ylab("Heterozygosity")+
...
ggplot(data = Het_seafan_df, aes(x = Site, y = value, fill = variable))+
  ...
  scale_fill_manual(values = c("pink", "#bdbdbd"))+
  ylab("Heterozygosity")+
...
[Calculate geographic distances (km) across seas using marmap](https://github.com/Tom-Jenkins/utility_scripts/blob/master/calculate_marine_lc_distances.R)  
